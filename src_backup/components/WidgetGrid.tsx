...
const ALL_WIDGETS: WidgetDef[] = [
  { id: "xp", label: "Experience", icon: "✨", component: XPWidget, defaultLayout: { w: 1, h: 1, minW: 1, minH: 1 } },
  { id: "streak", label: "Streak", icon: "🔥", component: StreakWidget, defaultLayout: { w: 1, h: 1, minW: 1, minH: 1 } },
  { id: "boss", label: "Boss Fight", icon: "👹", component: BossWidget, defaultLayout: { w: 2, h: 2, minW: 1, minH: 1 } },
  { id: "rank", label: "Guild Rank", icon: "🏆", component: RankWidget, defaultLayout: { w: 1, h: 1, minW: 1, minH: 1 } },
  { id: "quests", label: "Quests Today", icon: "⚔️", component: QuestsWidget, defaultLayout: { w: 2, h: 1, minW: 1, minH: 1 } },
  { id: "energy", label: "Energy", icon: "⚡", component: EnergyWidget, defaultLayout: { w: 1, h: 1, minW: 1, minH: 1 } },
];
  ...
  return (
    <div className="animate-fade-up" ref={containerRef}>
      ...
      <div className="flex items-center justify-between mb-3">
        <h2 className="font-[var(--font-fredoka)] text-base font-semibold text-slate-900">Overview</h2>
        <div className="flex items-center gap-2">
          {editing && removedWidgets.length > 0 && (
            <button
              onClick={() => { playSelect(); setPickerOpen(true); }}
              className="px-3 py-1.5 text-[11px] font-bold text-accent bg-accent/10 border border-accent/20 rounded-full hover:bg-accent/20 transition-colors cursor-pointer"
            >
              + Add Widget
            </button>
          )}
          <button
            ...
            tabIndex={0}
            data-focusable={true}
            className={`px-3 py-1.5 text-[11px] font-bold rounded-full transition-all cursor-pointer outline-none ${
              editing
                ? "bg-accent text-white shadow-[0_2px_12px_var(--color-accent-glow)]"
