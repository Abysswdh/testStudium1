  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 w-full animate-in fade-in duration-500 max-w-[1400px] mx-auto mt-6 gap-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="font-[var(--font-fredoka)] text-[32px] font-bold text-white tracking-wider flex items-center gap-3">
          <Swords className="text-purple-500" size={32} /> Ranked Arena
        </h1>
        <div className="bg-[#1c1927] border border-[#2e293f] rounded-2xl px-6 py-3 flex items-center gap-6 shadow-lg">
          <div className="flex flex-col">
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-widest">Current League</span>
            <span className="text-[16px] font-bold text-purple-400">Crystal III</span>
          </div>
          <div className="w-px h-8 bg-[#3f3852]" />
          <div className="flex flex-col">
            <span className="text-[11px] font-bold text-slate-500 uppercase tracking-widest">Duel Points</span>
            <span className="text-[16px] font-bold text-white">1,250 DP</span>
          </div>
        </div>
      </div>

      <div className="grid grid-cols-[2fr_1fr] gap-6 w-full flex-1 min-h-0">
        
        {/* Left Column: Matchmaking & Stats */}
        <div className="flex flex-col gap-6">
          
          {/* Hero Matchmaking Card */}
          <div className="bg-[#1f1b2e] border-2 border-[#2e293f] rounded-[32px] p-10 flex flex-col justify-center items-center relative overflow-hidden flex-1 group shadow-2xl">
            ...
            <div className="w-24 h-24 bg-purple-500/20 rounded-full flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(168,85,247,0.3)] animate-pulse">
              <Search size={40} className="text-purple-400" />
            </div>
            
            <h2 className="font-[var(--font-fredoka)] text-4xl font-bold text-white mb-2">Memory Duels</h2>
            <p className="text-slate-400 font-semibold mb-8 text-center max-w-md">
            ...
            <button
              ...
              className="px-12 py-4 bg-purple-600 hover:bg-purple-500 text-white font-[var(--font-fredoka)] text-xl font-bold rounded-2xl transition-all duration-300 shadow-[0_0_20px_rgba(168,85,247,0.4)] hover:shadow-[0_0_40px_rgba(168,85,247,0.6)] hover:-translate-y-1 active:translate-y-0"
            >
              Find Match
            </button>
          </div>
          ...
          {/* Quick Stats Row */}
          <div className="grid grid-cols-3 gap-6 h-[140px]">
