...
export default function ClientLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col md:flex-row w-screen h-screen overflow-hidden text-slate-100 selection:bg-accent/30 selection:text-white">
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative backdrop-blur-3xl">
        <TopStrip />
        <div className="flex-1 overflow-y-auto px-4 md:px-[32px] py-4 md:py-[24px] flex flex-col gap-6 scrollbar-none z-10 transition-opacity duration-300">
          {children}
        </div>
        <HUD />
      </div>
